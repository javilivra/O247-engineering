...
export const EPCOT_ATTRACTIONS: ParkItem[] = withPov([
  {
    ...
    image: '/images/attractions/ep/ep-guardians_galaxy.webp',
    heroImage: '/images/attractions/hero/hero_att_ep-guardians_galaxy.webp', vibes: ['thrill', 'indoor', 'dark'],
  ...
  },
  {
    ...
    land: 'World Discovery', tier: 'Tier 1', type: 'Attraction',
    image: '/images/attractions/ep/ep-test-track_outside.webp',
    heroImage: '/images/attractions/hero/hero_att_ep_test_track.webp', vibes: ['thrill', 'outdoor', 'fast'],
  ...
  },
  {
    ...
    image: '/images/attractions/ep/ep-frozen_ever_after.webp',
    heroImage: '/images/attractions/hero/hero_att_ep-frozen_ever_after.webp', vibes: ['family', 'indoor', 'water'],
  ...
  },
  {
    ...
    image: '/images/attractions/ep/ep-remy_ratatouille.webp',
    heroImage: '/images/attractions/hero/hero_att_ep-remy_ratatouille.webp', vibes: ['family', 'indoor', 'trackless'],
  ...
  },
  {
    ...
    image: '/images/attractions/ep/ep-soarin_over_the_world.webp',
    heroImage: '/images/attractions/hero/hero_att_ep-soarin_over_the_world.webp', vibes: ['family', 'indoor', 'simulator'],
  ...
  },
  {
    ...
    image: '/images/attractions/ep/ep-the_seas_with_nemo.webp',
    heroImage: '/images/attractions/hero/hero_att_ep-seas_nemo_friends.webp', vibes: ['family', 'indoor', 'gentle'],
  ...
  },
  {
    ...
    image: '/images/attractions/ep/ep-spaceship_earth_2.webp',
    heroImage: '/images/attractions/hero/hero_att_ep-spaceship_earth.webp', vibes: ['classic', 'indoor', 'gentle'],
  ...
  },
  {
    ...
    image: '/images/attractions/ep/ep-mission_space.webp',
    heroImage: '/images/attractions/hero/hero_att_ep-mission_space.webp', vibes: ['thrill', 'indoor', 'simulator'],
  ...
  },
  {
    ...
    image: '/images/attractions/ep/ep-journey_into_imagination_2.webp',
    heroImage: '/images/attractions/hero/hero_att_ep-journey_into_imagination.webp', vibes: ['classic', 'indoor', 'gentle'],
  ...
  },
  {
    ...
    land: 'World Nature', tier: 'Tier 3', type: 'Attraction',
    image: '/images/attractions/ep/ep-living_land.webp',
    heroImage: '/images/attractions/hero/hero_att_ep-living_land.webp', vibes: ['educational', 'indoor', 'gentle'],
    waitTime: '15 min', status: 'open',
  ...
  },
  {
    ...
    image: '/images/shows/ep/ep-gran_fiesta_tour.webp',
    heroImage: '/images/attractions/hero/hero_att_ep-gran_fiesta_tour.webp', vibes: ['family', 'indoor', 'boat', 'classic'],
    waitTime: '10 min', status: 'open',
  ...
  },
  {
    ...
    image: '/images/shows/ep/ep-reflections_of_China_2.webp',
    heroImage: '/images/attractions/hero/hero_att_ep-reflections_of_China.webp', vibes: ['family', 'indoor', 'film', 'classic'],
  ...
  },
  {
    ...
    image: '/images/shows/ep/ep_o_Canada.webp',
    heroImage: '/images/attractions/hero/hero_att_ep_o_Canada.webp', vibes: ['family', 'indoor', 'film', 'classic'],
    waitTime: '5 min', status: 'open',
  ...
  },
  {
    ...
    image: '/images/shows/ep/ep-impressions_de_France.webp',
    heroImage: '/images/attractions/hero/hero_att_ep-impressions_France.webp', vibes: ['family', 'indoor', 'film', 'classic'],
    waitTime: '5 min', status: 'open',
  ...
  },
  {
    ...
    land: 'World Showcase — France', tier: 'Tier 3', type: 'Attraction',
    image: '/images/shows/ep/ep-beauty_beast.webp',
    heroImage: '/images/attractions/hero/hero_att_ep-beauty_beast.webp', vibes: ['family', 'indoor', 'show', 'musical'],
    waitTime: '10 min', status: 'open',
