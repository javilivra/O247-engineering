...
// MK esta fijo en: top: 20%, left: 50%
export const ORIGIN_ZONES_DETAILED = [
  {
    label: "Resorts Area Magic Kingdom",
  ...
  {
    label: "Resorts Area Epcot / Hollywood",
  ...
  {
    label: "Resorts Area Animal Kingdom / Springs",
  ...
  },
  {
    ...
    options: [
      { id: 'off_universal', label: "Area Universal / I-Drive", distance: 14, type: 'off', hasDirectAccess: false, mode: 'car', mapPos: { top: 10, left: 80 } },
      { id: 'off_kissimmee', label: "Area Kissimmee / Champions Gate", distance: 18, type: 'off', hasDirectAccess: false, mode: 'car', mapPos: { top: 85, left: 40 } },
