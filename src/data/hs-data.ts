...
export const HS_ATTRACTIONS: ParkItem[] = withPov([
  {
    ...
    image: '/images/attractions/hs/hs-rise_of_resistance.webp', heroImage: '/images/attractions/hero/hero_att_hs-rise_of_resistance.webp', vibes: ['thrill', 'indoor', 'dark', 'immersive'],
  ...
  },
  {
    ...
    image: '/images/attractions/hs/hs-slinky_dog_dash.webp', heroImage: '/images/attractions/hero/hero_att_hs-slinky_dog_dash.webp', vibes: ['family', 'outdoor', 'coaster'],
  ...
  },
  {
    ...
    image: '/images/attractions/hs/hs-tower_of_terror.webp', heroImage: '/images/attractions/hero/hero_att_hs-tower_of_terror.webp', vibes: ['thrill', 'indoor', 'dark', 'drops'],
  ...
  },
  {
    ...
    land: 'Sunset Boulevard', tier: 'Tier 1', type: 'Attraction',
    image: '/images/attractions/hs/hs-rock_roll_coaster.webp', heroImage: '/images/attractions/hero/hero_att_hs-rock_roll_coaster.webp', vibes: ['thrill', 'indoor', 'dark', 'fast'],
  ...
  },
  {
    ...
    image: '/images/attractions/hs/hs-toy_story_mania.webp', heroImage: '/images/attractions/hero/hero_att_hs-toy_story_mania.webp', vibes: ['family', 'indoor', 'interactive'],
  ...
  },
  {
    ...
    image: '/images/attractions/hs/hs-mickey_minnie_runaway.webp', heroImage: '/images/attractions/hero/hero_att_hs-mickey_minnie_runaway.webp', vibes: ['family', 'indoor', 'trackless'],
  ...
  },
  {
    ...
    image: '/images/attractions/hs/hs-alien_swirling_saucers.webp', heroImage: '/images/attractions/hero/hero_att_hs-alien_swirling_saucers.webp', vibes: ['family', 'outdoor', 'spinning'],
  ...
  },
  {
    ...
    image: '/images/attractions/hs/hs-muppet_vision_3d_2.webp', heroImage: '/images/attractions/hero/hero_att_hs-muppet_vision_3d_2.webp', vibes: ['classic', 'indoor', 'show'],
  ...
  },
  {
    ...
    image: '/images/attractions/hs/hs-star_tours_adventure.webp', heroImage: '/images/attractions/hero/hero_att_hs-star_tours_adventure.webp', vibes: ['thrill', 'indoor', 'simulator'],
  ...
  },
  {
    ...
    image: '/images/attractions/hs/hs-lightning_mcqueen_racing_academy.webp', heroImage: '/images/attractions/hero/hero_att_hs-lightning_mcqueen_racing_academy.webp', vibes: ['family', 'indoor', 'show'],
  ...
  },
  {
    ...
    image: '/images/attractions/hs/hs-voyage_little_mermaid.webp', heroImage: '/images/attractions/hero/hero_att_hs-voyage_little_mermaid.webp', vibes: ['family', 'indoor', 'show', 'dark'],
  ...
  },
  {
    ...
    land: 'Animation Courtyard', tier: 'Tier 3', type: 'Attraction',
    image: '/images/attractions/hs/hs-disney_jr_play_dance.webp', heroImage: '/images/attractions/hero/hero_att_hs-disney_jr_play_dance.webp', vibes: ['family', 'indoor', 'show', 'kids'],
    waitTime: '10 min', status: 'open',
