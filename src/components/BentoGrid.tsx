...
// F16: Definición de tipos estricta (Adiós 'any')
...
const FeatureCard = ({ title, desc, iconName, children, className = "" }: FeatureCardProps) => (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <ScrollReveal delay={0.3} width="100%">
           ...
           {/* Card Security (F16: Claim ajustado) */}
           <ScrollReveal delay={0.4} width="100%">
            <FeatureCard
              title="Privacidad Blindada"
              desc="Tus preferencias viajan seguras. Sin venta de datos a terceros. Protocolos de encriptación estándar."
            ...
            >
               <div className="flex gap-3 mt-4">
                  <span className="px-3 py-1.5 bg-bone rounded-md text-xs border border-gunmetal/10 text-gunmetal/60 flex items-center gap-2 font-mono">
                     {/* Cambiado AES-256 por algo más genérico pero seguro */}
                     <Icon icon="solar:lock-password-outline" /> SECURE DATA STANDARD
                  </span>
               </div>
            </FeatureCard>
          </ScrollReveal>
